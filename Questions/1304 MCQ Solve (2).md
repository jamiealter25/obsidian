...
25. **\_\_\_\_\_\_ do not return a value.** (T-231, Q36)
    (a) Sub procedure
...
26. **If you set interval properly of Timer control to 1000, which is equivalent to?**
    (a) 1 second
    (b) 0.1 second
    (c) 0.01 second
    (d) 10 second
...
33. **Which of the following is used to hide the content in textbar** (T-231, Q12)
    (a) caption
    (b) hiden
    (c) password char
    (d) name
