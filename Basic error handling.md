...
`try:     # Code that might cause an error     x = 10 / 0 except:     # Code that runs if there's an error     print("Oops! Something went wrong.")`
...
`try:     num = int("abc")  # This will cause ValueError except ValueError:     print("Invalid number format!")`
...
`try:     num = int(input("Enter a number: ")) except ValueError:     print("That's not a number!") else:     print(f"You entered {num}") finally:     print("Program finished.")`